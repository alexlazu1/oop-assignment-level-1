...
public final class Constants {
    ...
    public static final String SUCCESS_SEE_DETAILS = "success see details";
    public static final String SUCCESS_BUY_TOKENS = "success buy tokens";
    public static final String SUCCESS_PURCHASE_MOVIE = "success purchase movie";
    public static final String SUCCESS_WATCH_MOVIE = "success watch movie";
    public static final String SUCCESS_LIKE_MOVIE = "success like movie";
    public static final String SUCCESS_RATE_MOVIE = "success rate movie";
    public static final String SUCCESS_BUY_PREMIUM = "success buy premium";
